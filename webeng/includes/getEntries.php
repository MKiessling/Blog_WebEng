...
echo "<div class=ribbon-wrapper-blue><div class=ribbon-blue>Blog</div></div>";

// query returning information of entries and comments
$sql = 'SELECT entries.id, entries.title, entries.datecreated, 
               entries.content, entries.datelastchanged, entries.author, 
               entries.changedby, COUNT( comments.id ) AS count
        FROM entries
...
// if result contains rows -> show all blog-entries
if (!$result->num_rows) {
